...
> **状态声明**：本文为意图声明文档，非可执行发布流程。当前 Kairos 处于文档草稿阶段（无运行代码），以下流程以代码就绪为前置条件。待 v1.0.0-draft 定稿、代码启动后，本文须重写为可执行的 CI/CD 流程。
...
**v1.0.0 特殊规则**：v1.0.0 = 设计冻结版（当前版本）。代码首版（首次可运行）从 v1.1.0 起——设计冻结与代码发布在版本号上明确分离。
