...
| Web 框架 | Litestar | ≥ 2.0 | 异步优先，类型安全，OpenAPI 自动生成 |
| ASGI 服务器 | Uvicorn | ≥ 0.22 | 与 Litestar 原生集成 |
| 任务调度 | APScheduler | ≥ 3.10 | 升华/遗忘/重估等周期性任务调度 |
...
| 连接池（标准模式） | asyncpg + pgpool | — | 异步数据库连接 |
...
|:------|:----------|:---------|:--------|:--------|:------|
| 3.11–3.12 | 15–17 | 0.5–0.7 | 2.0–2.4 | 0.22–0.29 | 标准模式 |
| 3.11–3.12 | SQLite 3.40+ | sqlite-vec 0.1+ | 2.0–2.4 | 0.22–0.29 | 轻量模式 |
