...
## 四、核心能力 · Core Capabilities（101 项）
...
| **📋 specification** | API规格 / 数据模型 / 功能清单(101项) / 实现映射 / 操作目录(50项) / 追缴清单 / 需求 / NFR / 详细设计 |
...
| 阶段 | 状态 |
|:-----|:-----|
|| 🏗 文档底座 | ✅ **已完成** — 52 份文档，101 项能力规格就绪 |
| 🎯 架构冻结 | ✅ **已完成** — 设计决策全部收敛，已知债务分类在册 |
| 📝 系统设计 | ✅ **已完成** — 数据模型/API规格/实现映射/操作目录就绪 |
|| 💻 代码实现 | 🚧 **开发中** — 核心引擎 `amber/`（main.py 734 行 + API 19 模块 + schema.sql 449 行）已实现，待文档体系定稿后对齐发布 |
...
| **功能清单（101 项）** | [`docs/specification/feature-list.md`](docs/specification/feature-list.md) |
